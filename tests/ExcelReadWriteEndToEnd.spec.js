...
test('@File Upload download excel validation', async ({ page }) => {
  ...
  const filePath = '/Users/Swati/Downloads/download.xlsx'; 
  //Test is failing as file is not downloading, to pass this this manually download the file
  // or await dl.path()
