...
```
Error: locator.click: Error: strict mode violation: getByRole('option') resolved to 251 elements:
    1) <option value="" disabled>Choose an option</option> aka getByRole('combobox')
    2) <option value="AF">Afghanistan</option> aka getByRole('combobox')
    3) <option value="AX">Aland Islands</option> aka getByRole('combobox')
    4) <option value="AL">Albania</option> aka getByRole('combobox')
    5) <option value="DZ">Algeria</option> aka getByRole('combobox')
    6) <option value="AS">American Samoa</option> aka getByRole('combobox')
    7) <option value="AD">Andorra</option> aka getByRole('combobox')
    8) <option value="AO">Angola</option> aka getByRole('combobox')
    9) <option value="AI">Anguilla</option> aka getByRole('combobox')
    10) <option value="AQ">Antarctica</option> aka getByRole('combobox')
    ...
...
> 43 |     await page.getByRole("option", {value: 'AL'}).click();
     |                                                   ^ Error: locator.click: Error: strict mode violation: getByRole('option') resolved to 251 elements:
